...
{
	// 정점 및 픽셀 쉐이더를 초기화합니다.
	return InitializeShader(device, hwnd, (WCHAR*)L"../DirectXEngine/TextureVs.hlsl", (WCHAR*)L"../DirectXEngine/TexturePs.hlsl");
}
