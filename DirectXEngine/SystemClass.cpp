...
void SystemClass::Run()
{
	...
	//사용자로부터 종료 메세지를 받을 때 까지 메세지 루프를 돕니다.
	while (true)
	{
		//윈도우 메세지를 처리합니다.
		if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE))
		{
			//종료 메세지를 받은 경우 메세지 루프를 탈출합니다
...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	{
		//윈도우 모드의 경우 1920*1080 크기를 지정합니다
		screenWidth = 1920;
		screenHeight = 1080;

		//윈도우 창을 가로, 세로의 정 가운데에 오도록 합니다.
